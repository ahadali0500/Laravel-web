                        ...
                        <tr style='vertical-align:middle;' valign='middle'>
                            <td align='center' style='padding:30px;' class='content'>
                                <table align='center' role='presentation' border='0' cellpadding='0' cellspacing='0'
                                    ...
                                    <tr>
                                        <td>
                                            <center><img src='https://tombag.dailydebuggers.tech/logo/logo2.jpeg' style='width:100px'></center>
                                        </td>
                                    </tr>
                                    <tr style='vertical-align:middle;' valign='middle'>
                                        <td class='content'>
                                            <h3
                                                style='text-align: center; color:#000000;font-size:20px;mso-line-height-rule:exactly;line-height:24px;font-family:Arial,sans-serif;!important;'>
                                                <span style="font-size:23px">Hi,
                                                    <b>{{ $mailData['name'] }}</b><br></span>Your Account has been
                                                Approved.
                                            ...
                                            <center>
                                                <p
                                                    ...
                                                    <a href='https://tombag.dailydebuggers.tech/login/'
                                                        style='background-color: #4aa5a8; /* Green */border: none;color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;margin: 4px 2px;cursor: pointer;border-radius: 5px;'>Login
                                                        Page</a>
                                                </p>
                                            </center>
                                            <hr>
                                            <p
                                                style='color:#000000;font-size:17px;mso-line-height-rule:exactly;line-height:24px;font-family:Arial,sans-serif;!important;'>
                                                Best regards,<br>
